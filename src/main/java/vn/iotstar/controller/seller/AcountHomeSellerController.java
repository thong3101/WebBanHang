...
@WebServlet(urlPatterns = { "/seller/acount" })
public class AcountHomeSellerController extends HttpServlet{


	/**
	 * 
	 */
	private static final long serialVersionUID = -2342576211819718906L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/views/seller/seller-acount.jsp");
