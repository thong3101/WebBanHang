...
public class ProductEditController extends HttpServlet{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4390714715374279530L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ProductModel Product = proService.get(Integer.parseInt(id));
		req.setAttribute("product", Product);
		
		
		RequestDispatcher dispatcher = req.getRequestDispatcher("/views/seller/seller-product-edit.jsp");
